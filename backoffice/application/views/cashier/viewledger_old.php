...
<?php
	...
	$j=$page;
     ...
     $DATE        = $results[$i]->TRANSACTION_DATE;
     ...
     //print_r($expResult);die;
     if($results[$i]->TRANSACTION_TYPE_ID == $expResult[0] || $results[$i]->TRANSACTION_TYPE_ID == $expResult[1]){
     ...
     if($results[$i]->TRANSACTION_TYPE_ID == $this->cashier_model->OutPointsTransTypeId()){
   ...
   <p class="searchWrap1" style="height:30px;">
    ...
    <b> Total Users: <font color="#FF3300">(<?php echo $j; ?>) </font></b> &nbsp;&nbsp;&nbsp;
      ...
      <table id="list4" class="data">
       ...
       <div id="pager3"></div>
        ...
        <script type="text/javascript">
                jQuery("#list4").jqGrid({
                    datatype: "local",
					colNames:['S.No','User Name','Transaction Id','Date','Old Points','In Points','Out Points','New Points'],
                    colModel:[
                        {name:'SNO',index:'SNO', align:"center", width:20, sorttype:"int"},
			{name:'USERNAME',index:'USERNAME', align:"center", width:60},
                        {name:'TRANS_ID',index:'TRANS_ID', align:"center", width:80},
                        {name:'DATE',index:'DATE', align:"center", width:80},
			{name:'OLD_POINTS',index:'OLD_POINTS', align:"center", width:60},
			{name:'IN',index:'IN', align:"center", width:60},
                        {name:'OUT',index:'OUT', align:"center", width:60},
			{name:'NEW_POINTS',index:'NEW_POINTS', align:"center", width:60},
...
<div class="Agent_TotalShdr" style="width:615px;">TOTAL:</div>

<div class="Agent_TotalRShdr" style="width:115px"><center><?PHP if($TotInPoints){echo number_format($TotInPoints,2,".","");}else{echo "0.00";}?></center></div>
<div class="Agent_TotalRShdr" style="width:115px"><center><?PHP if($TotOutPoints){echo number_format($TotOutPoints,2,".","");}else{echo "0.00";}?></center></div>
...
<?php echo $this->load->view("common/footer"); ?><table width="100%" class="ContentHdr">
  <tr>
    <td><strong> Ledger </strong></td>
  </tr>
</table>
