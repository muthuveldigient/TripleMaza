...
<div class="content_wrap">
  <div class="tableListWrap">
    <table width="100%" class="ContentHdr">
      <tr>
        <td><strong>In Point Reports</strong></td>
      </tr>
    </table>
     	<?php
      ...
      <tr>
        <td><table width="100%" cellpadding="10" cellspacing="10">
          <tr>
            ...
            <td width="40%"><span class="TextFieldHdr">Affliates:</span><br />
              <label>
                                   ...
                                   if(isset($results)){ 
                                    if(count($results)>0 && is_array($results)){
                                        for($i=0;$i<count($results);$i++){
												...
												$resvalue['DISTRIBUTOR']= $distributorName;
    ...
    <div class="tableListWrap">
      <div class="data-list">
        ...
        <script type="text/javascript">
                jQuery("#list4").jqGrid({
                    datatype: "local",
					colNames:['S.No','Username','Email','Partner','Distributor','Country','Register Date','Profile Image','',''],
                    colModel:[
