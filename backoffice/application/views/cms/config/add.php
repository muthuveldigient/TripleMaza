                 ...
                 <select name="BANNER_POSITION" class="TextField" id="BANNER_POSITION">
                  <option value="">Select</option>
                    <?PHP foreach($bannerPositions as $position){ ?>
                     <option value="<?PHP echo $position->POSITION_ID.'-'.$position->POSITION;?>"><?PHP echo $position->POSITION;?></option>
				   <?PHP }  ?>
  				</select>
           ...
           <tr>
                 ...
                 <select name="BANNER_LANGUAGE" class="TextField" id="BANNER_LANGUAGE">
                  <option value="">Select</option>
                    <?PHP foreach($languages as $language){ ?>
                     <option value="<?PHP echo $language->LOCALE_CODE;?>"><?PHP echo $language->LOCALE_NAME;?></option>
				   <?PHP }  ?>
  				</select>
                <span class="mandatory">*</span></label></td>
           </tr>
            ...
            <tr>
              <td width="40%"><span class="TextFieldHdr">Banner Link:</span><br />
                <label>
                <input type="text" name="BANNER_LINK" id="BANNER_LINK" class="TextField">
                <span class="mandatory">*</span></label></td>
           </tr>  
