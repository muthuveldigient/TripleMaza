...
class Ajax extends CI_Controller{
	...
	*/
	...
	public function tourinfo(){
	   ...
	   //bulild HTML string
	   $htmlString = "<table>";
	   $htmlString .= "<tr><td><img height='150' src=".base_url()."images/poker-cards.png><br /><img height='150' src=".base_url()."images/poker-cards1.png><br /><img width='128' height='200'  src=".base_url()."images/poker-cards2.png></td>";
	   $htmlString .= "<td>";
	...
	public function winbox(){
	    $winnerCount = $this->uri->segment(4, 0);
	...
	public function winners(){
	    echo $tourId = $this->uri->segment(4, 0);
