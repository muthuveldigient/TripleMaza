...
<div class="content_wrap">
  ...
  <tr>
    <td><div align="right"><a href="<?php echo base_url();?>cms/language/add" class="dettxt">Add New Language</a></div></td>
  </tr>
</table>
                                   ...
                                   if(isset($results)){ 
                                    if(count($results)>0 && is_array($results)){
                                        ...
                                        for($i=0;$i<count($results);$i++){
												...
												$resvalue['SNO']=$j+1;
												$resvalue['LOCALE_NAME']	= trim($results[$i]->LOCALE_NAME);
												$resvalue['LOCALE_CODE']	= $results[$i]->LOCALE_CODE;
												$resvalue['EDIT']			= '<a href="language/edit/'.$results[$i]->LOCALE_ID.'"><img src="'.base_url().'static/images/edit-img.png" alt="history"></a>';
												
												$resvalue['DELETE']					= '<a href="language/delete/'.$results[$i]->LOCALE_ID.'" onClick="return confirmDelete();"><img src="'.base_url().'static/images/delete.png" alt="Delete"></a>';
    ...
    <div class="tableListWrap">
      <div class="data-list">
        ...
        <script type="text/javascript">
                jQuery("#list4").jqGrid({
                    datatype: "local",
					colNames:['S.No','Language','Language Code','Edit','Delete'],
                    colModel:[
                        {name:'SNO',index:'SNO', align:"center", width:35, sorttype:"int"},
						{name:'LOCALE_NAME',index:'LOCALE_NAME', align:"center", width:80},
						{name:'LOCALE_CODE',index:'LOCALE_CODE', align:"center", width:80},
