      ...
      <tr>
        <td>
          <table width="100%" cellpadding="10" cellspacing="10">
            <tr>
              <td width="40%"><span class="TextFieldHdr">Language Name:</span><br />
                <label>
                 <input type="text" name="LANGUAGE" id="LANGUAGE" value="<?php echo $lang->LOCALE_NAME; ?>" class="TextField">
                <span class="mandatory">*</span></label></td>
             
              <td width="40%"><span class="TextFieldHdr">Language Code:</span><br />
                <label>
                 <input type="text" name="LANGUAGE_CODE" id="LANGUAGE_CODE" value="<?php echo $lang->LOCALE_CODE; ?>" class="TextField">
                <span class="mandatory">*</span></label></td>
                <td>
                </td>
               </tr>
          ...
          <div class="SeachResultWrap2">
            <input type="hidden" name="lang_id" value="<?php echo $lang->LOCALE_ID; ?>">
