          ...
          <table width="100%" cellpadding="10" cellspacing="10">
            <tr>
              <td width="40%"><span class="TextFieldHdr">News Title:</span><br />
                <label>
                 <input type="text" name="NEWS_TITLE" id="NEWS_TITLE" value="<?php echo $news->NEWS_TITLE; ?>" class="TextField">
                <span class="mandatory">*</span></label></td>
           </tr>  
              <tr>
              <td width="40%"><span class="TextFieldHdr">News Description:</span><br /><br />
                <label>
                 <textarea id="NEWS_DESC" name="NEWS_DESC"><?php echo $news->NEWS_DESCRIPTION; ?></textarea>
               </label></td>
                <td>
                </td>
              </tr>
            <tr>
              <td width="40%"><span class="TextFieldHdr">Active Days:</span><br />
                <label>
                <?php
				 $activeHours  = $news->ACTIVE_HOURS;
				 $activeDays   = $activeHours/24;
				 
				?>
                <select name="ACTIVE_DAYS" class="TextField" id="ACTIVE_DAYS">
                  <option value="">--Day--</option>
                    <?PHP for($i=1; $i<=10; $i++){ ?>
                     <option <?php if($activeDays == $i) echo 'selected="selected"'; ?> value="<?PHP  echo $i;?>"><?PHP echo $i;?></option>
				   <?PHP }  ?>
  				</select>
                <span class="mandatory">*</span></label></td>
           </tr>  
