...
<div class="content_wrap">
   ...
   <form action="<?php echo base_url()?>games/game/userhistory?rid=<?php echo $rid?>" method="post" name="tsearchform" id="tsearchform" onsubmit="return chkdatevalue();">
  ...
  <td><form action="<?php echo base_url();?>games/game/userhistory?rid=<?php echo $rid;?>" method="post" name="clrform" id="clrform">
		...
		if(count($results)>0 && is_array($results)){
			for($i=0;$i<count($results);$i++){
				...
				if($results[$i]->INTERNAL_REFERENCE_NO){
					$resvalue['INTERNAL_REFERENCE_NO']	= '<a href="#" onclick="NewWindow(\''.base_url().'gamedetails/view/'.$results[$i]->INTERNAL_REFERENCE_NO.'?rid=73\',\'Game Details\',\'1024\',\'900\',\'yes\')">'.$results[$i]->INTERNAL_REFERENCE_NO.'</a>';
				}else{
