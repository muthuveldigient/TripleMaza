...
<div class="data-list">
	...
	jQuery("#listsg11").jqGrid({
		...
		subGridRowExpanded: function(subgrid_id, row_id) {
			...
			var aurls = '<?php echo base_url()."reports/ajaxgrid/gameinfo?q=2&GAMES_TYPE=$GAMES_TYPE&PARTNER_TYPE=$PARTNER_TYPE1&START_DATE_TIME=$START_DATE_TIME&END_DATE_TIME=$END_DATE_TIME&keyword=Search"?>&AGENT_LIST='+row_id; 
		...
		loadComplete: function () {
			...
			for(var i=0;i< mydata.length;i++) {
				rowid = mydata[i].id;
				jQuery("#listsg11").jqGrid('addRowData',rowid,mydata[i]);
			}
