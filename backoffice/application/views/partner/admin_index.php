...
function activatedeaUser(curStatus,adminID,newStatus) {
	...
	var url="<?php echo base_url();?>partner/admin/changeActiveAdminStatus/"+curStatus+"/"+adminID+"/"+newStatus;
