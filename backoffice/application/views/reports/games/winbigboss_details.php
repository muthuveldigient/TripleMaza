...
<?php
 $info = $this->game_model->getWinBigBossSumDetails($handId,$gameId); 
?>
<div class="tableWrap">
	...
	$results = $this->game_model->getWinBigBossPlayDetails($handId, $gameId);  
 $i=1;
...
?>
      <tr>
        ...
        <td class=""><table width="100%" align="center" class="NSTblHdrTxt">
            <tr>
              <td class="text-center"><?= (!empty($gameName)?$gameName:'')?></td>
            </tr>
          </table></td>
        <td class=""><table width="100%" align="center" class="NSTblHdrTxt">
            <tr>
