              ...
              <td width="40%"><span class="TextFieldHdr">Page Name:</span><br />
                <label>
                  <select class="TextField" name="PAGE_NAME" id="PAGE_NAME"> 
                   ...
                   <option <?php if($page->STATIC_PAGE_MASTER_ID == $menu->STATIC_PAGE_MASTER_ID) echo 'selected="selected"'; ?> value="<?php echo $menu->STATIC_PAGE_MASTER_ID;?>"><?php echo $menu->PAGE_NAME;?></option>
                   <?php } ?>
                 </select>
              ...
              <td width="40%"><span class="TextFieldHdr">Page Language:</span><br />
                <label>
                 <select class="TextField" name="PAGE_LANG" id="PAGE_LANG"> 
                   ...
                   <option <?php if($page->LOCALE_ID == $lang->LOCALE_ID) echo 'selected="selected"'; ?>  value="<?php echo $lang->LOCALE_ID;?>"><?php echo $lang->LOCALE_NAME;?></option>
                   <?php } ?>
                 </select>
                <span class="mandatory">*</span></label></td>
               </tr>
              ...
              <td width="40%"><span class="TextFieldHdr">Page Visible:</span><br />
                <label>
                 <select class="TextField" name="PAGE_VISIBLE" id="PAGE_VISIBLE"> 
                   ...
                   <option <?php if($page->PAGE_VISIBLE_STATUS == 1) echo 'selected="selected"'; ?> value="1">Pre Login</option>
                   <option <?php if($page->PAGE_VISIBLE_STATUS == 2) echo 'selected="selected"'; ?> value="2">Post Login</option>
                 </select>
                <span class="mandatory">*</span> </label></td>
            </tr>
            <tr>
              <td width="40%"><span class="TextFieldHdr">Page Title:</span><br />
                <label>
                <input name="PATE_TITLE" type="text" class="TextField" id="PATE_TITLE" maxlength="15" tabindex="2" value="<?php echo $page->STATIC_PAGE_TITLE; ?>" />
                <span class="mandatory">*</span></label></td>
               </tr>
               <tr>
                  <td width="40%"><span class="TextFieldHdr">Page Content:</span><br /><br />
                <label>
                <textarea id="PAGE_CONTENT" name="PAGE_CONTENT"><?php echo $page->CONTENT_TEXT; ?></textarea>
               </label></td>
            </tr>
          </table>
          <div class="SeachResultWrap2">
            <input type="hidden" name="pageid" value="<?php echo $page->STATIC_PAGE_ID; ?>">
