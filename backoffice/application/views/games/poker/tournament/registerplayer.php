      ...
      <div class="UpdateMsgWrap">
        <table width="100%" class="SuccessMsg">
          <tr>
            ...
            <td width="95%">User Successfully Registered!</td>
          </tr>
        </table>
      </div>
       ...
       <table width="100%" class="ErrorMsg">
        <tr>
          <td width="45"><img src="<?php echo base_url();?>static/images/icon-error.png" alt="" width="45" height="34" /></td>
    	    <td width="95%">User Already Registered To This Tournament!</td>
        </tr>
      </table>
     </div>
       ...
       <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#993366" class="searchWrap">
        ...
        <tr>
          <td><table width="100%" class="PageHdr">
              <tr>
                <td><strong>Register Player into tournament</strong></td>
              </tr>
            </table>
            <table width="100%" cellpadding="10" cellspacing="10">
              <tr>
                <td width="40%"><span class="TextFieldHdr">Tournament Name<span id="usernamespan" class="mandatory">*</span>:</span><br />
                  <label>
									<select id="TOURNAMENT_NAME" name="TOURNAMENT_NAME" class="TextField" >
                     <option value=""> Select </option>
                     <?php foreach($tournaments as $tournament){ ?>
                      <option value="<?php echo $tournament->TOURNAMENT_ID; ?>"><?php echo $tournament->TOURNAMENT_NAME.'--'.$tournament->TOURNAMENT_START_TIME; ?></option>
                      <?php  } ?>
                   </select>
                   </label></td>
        ...
        <td style="padding-bottom: 10px; padding-top: 10px;"><input style="position:relative;left:10px;" type="submit" name="Submit" id="Submit"  value="Give Promotional Ticket" tabindex="6"  />
          &nbsp;&nbsp;&nbsp;
