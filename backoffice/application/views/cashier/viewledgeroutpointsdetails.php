...
<script src = "<?php echo base_url();?>js/datetimepicker_css.js"  type="text/javascript" language="javascript"></script>
<script>
...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#993366" class="searchWrap">
   <form action="<?php echo base_url();?>admin_home/?p=voutpts&parid=<?php echo base64_encode($parid);?>" method="post" name="tsearchform" id="tsearchform">
        <tr>
          <td>
        ...
        <td width="40%"><span class="TextFieldHdr">Start Date:</span><br />
          ...
          </label><a onclick="NewCssCal('START_DATE_TIME','ddmmyyyy','arrow',true,24,false)" href="#"><img src="<?php echo base_url()?>images/calendar.png" /></a></td>
        <td width="40%"><span class="TextFieldHdr">End Date:</span><br />
          ...
          </label><a onclick="NewCssCal('END_DATE_TIME','ddmmyyyy','arrow',true,24,false)" href="#"><img src="<?php echo base_url()?>images/calendar.png" /></a></td>
      ...
      <tr>
          <td width="40%">
              ...
              <tr>
                ...
                <td>
    <form action="<?php echo base_url();?>admin_home/?p=voutpts&parid=<?php echo base64_encode($parid);?>" method="post">    
...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url();?>jquery/css/ui.jqgrid.css" />
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url();?>jquery/css/jquery-ui-1.css">
...
$arrs=$ledgerlist;
?>
<form name="myfrm" id="myfrm" action="<?php echo base_url()?>inpointsexcelexpot/outpointexcel" method="post">
<input type="hidden" name="inpointsdata" value="<?php echo $str;?>" />
<input type="hidden" name="totalinpoints" value="<?php echo $tpoints;?>" />
</form>
<div style="padding-top:10px;float:left;font-family:arial;font-size:11px;padding-right:10px;">Export: <a href="#" onclick="javascript:document.myfrm.submit()"><img src="<?php echo base_url()?>images/excel.jpg" height="20" width="20"></a></div>
<?php
}
if($totalpoints){
?>
...
<?php } ?>
<div id="pager3"></div>
<script src="<?php echo base_url();?>jquery/js/jquery-1.7.2.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>jquery/js/i18n/grid.locale-en.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>jquery/js/jquery.jqGrid.min.js" type="text/javascript"></script>
<script type="text/javascript">
jQuery("#list4").jqGrid({
	datatype: "local",
   	//colNames:['S.no','Trans.Id','Date', 'User Id','Old Points','In','Out','New Points','Processed By', 'Comment'],
        colNames:['S.no','User Id','Old Points','Out','New Points','Processed By', 'Comment'],
   	colModel:[
